				...
				<div class="mypage_top_info" style="margin: 10px; padding: 10px;">
					...
					<div class="my_sum" style="float: left">
						<div style="clear: both;">
							<br>
							<h2>
								<strong><%=loginMember.getName()%></strong> 님. 취소/반품/교환 조회
							</h2>
						</div>
					</div>
				</div>
					...
					<table width="800" cellpadding="5" cellspacing="3" bgcolor="#fbeeac">
						...
						<tbody>
							<tr bgcolor="#f4d160">
								...
								<th scope="col" class="myacc_th01">상태</th>
							</tr>

							<tr>
								<td class='td_date myacc_td03'>2021-04-22</td>
								<td class='td_link myacc_td03'><a href=''>001-A777343077

										<td class='td_date myacc_td03'>김냥멍</td>
