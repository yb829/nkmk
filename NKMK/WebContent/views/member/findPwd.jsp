...
<section id="content" align="center">
	<form id="findForm" action="<%= request.getContextPath() %>/member/findPwd" method="POST" target="popup_window">
		<table align="center">
			<br><br>
			<tr>
				<th>비밀번호 찾기</th>
			...
			<tr>
				<td><input class="input_size" type="text" name="id" placeholder="아이디" required></td>
				<td><input type="hidden" name="identify2" value="b"></td>
			</tr>	
		</table>
	</form>
